...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.showErrorStatus = function(data) {
       checkSessionId(data);// Added by Nikhil
       return this.showStatus(data);
    };
    /* Nikhil Starts for Swagger API changes */
    function checkSessionId(data) { 
      var el_session_id = document.getElementsByName("sessionId");
          el_session_id = document.getElementsByName("sessionId")[0].value;
          if(getCookie("sessionKey")==el_session_id && data.statusText=='java.lang.Exception: Session does not exist'){ 
            log("checkSessionId" + data.status);
            window.location = "https://preview.oddz.com/cas";
          }
    }
    ...
    function getCookie(c_name)
    {
     ...
     /* Nikhil Ends for Swagger API changes */
